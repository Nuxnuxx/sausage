...
public class GetTopRatedLogementsUseCase(IRepositoryFactory repositoryFactory)
{
    public async Task<List<LogementWithRatingDto>> ExecuteAsync(int count)
    {
        ...
        var logementsWithAverage = logements.Select(l => new
        {
            Logement = l,
